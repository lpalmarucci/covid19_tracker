...
export default function AccordionHeader({ handleClick }: Props): ReactElement {
    ...
    return (
        <>
            <h2 className="mb-0 flex items-center justify-between" onClick={handleClick}>
                <button
                ...
                <div className={`w-5 h-5 border-t-2 border-l-2 border-gray-300 transition-all delay-100 duration-300 m-6 mt-9
