...
export default function AccordionHeader({ }: Props): ReactElement {
    ...
    return (
        <>
            <h2 className="mb-0 flex items-center justify-between">
                ...
                <div className={`w-5 h-5 border-t-2 border-l-2 border-gray-300 transition-all delay-100 duration-300 m-4
                    ${isOpen ? '-rotate-135 mt-0' : 'rotate-45  mt-6'}`}>
                </div>
            </h2>
        </>
    )
