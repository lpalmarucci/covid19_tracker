...
export default function Dataset({ data, countryName }: Props): ReactElement {
    ...
    return (
        <div className="container py-20 mx-auto">
            <h1 className="text-5xl font-bold text-center pt-5 dark:text-white">{countryName}</h1>
            <h3 className="italic text-center mt-4 text-gray-500">Ultimo aggiornamento: {formattedDate}</h3>
